    ...
    view! {
        <div class="max-w-4xl mx-auto py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <a href="/products/renivel" class="block border border-slate-800/80 bg-slate-900/50 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group hover:border-cyan-500/50 transition-colors">
                ...
                <div class="block border border-slate-800/40 bg-slate-900/20 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden">
