...
pub fn AppLayout(children: Children) -> impl IntoView {
    view! {
        <div class="min-h-screen bg-slate-950 text-slate-200 selection:bg-cyan-400/30">
            ...
            <main class="flex-1 w-full mx-auto container px-4 sm:px-6 lg:px-8 py-12">
                {children()}
            </main>
            
            <footer class="border-t border-slate-800/60 py-8 mt-auto">
